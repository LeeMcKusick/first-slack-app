...
const message = {
  "text": "Welcome to the team! We're gladd you're here.",
  "attachments": [
    {
      "title": "What is Slack?",
...
//initialize the Slack Events API using signing SLACK_SIGNING_SECRET
...
//Set up Express to be used with Events API
...
slackEvents.on('team_join', (event) => {
  ...
  slackWeb.chat.postMessage({
    ...
    fs.readFile('database.json', (err, data) => {
      ...
      //and finally, string up the data and write it back to the file
